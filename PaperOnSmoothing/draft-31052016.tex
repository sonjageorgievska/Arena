...
To estimate positions from these groups of measurements (signal strengths) a chi-square data fit is performed.\\

The uncertainties associated with the chi-square fits are given by the covariance matrix, which is the inverse of the matrix of second-order derivatives of the chi-square function.
The values in the covariance matrix give the uncertainty in the parameters that corresponds to a $1\sigma$ error or an increase of $\chi^2+1$.
