...
\begin{enumerate}
	...
	\begin{figure}[h!]
		...
		\label{fig:bimodal}
	\end{figure} 
	The resulting plot (for the x-coordinate) reveals a bimodal distribution of the estimation. We have observed such a distribution in a majority of the 20 randomly sampled MAC addresses. This phenomenon can be explained by the multiple local optima situation, because we did not observe bi-modal distributions in the signal strengths. (***** Sonja: better to first write the observation of bimodality and then the multiple local optima possible explanation***)
