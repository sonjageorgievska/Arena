...
\begin{figure}[h!]
	...
	\caption{Estimations of x-coordinates of a static MAC device as a function of time}
	\label{fig:randomized}
\end{figure} 

Thus, when estimating crowd density, we ignore the MAC devices that have a randomized address and at the end we multiply the crowd density by 1.0225, to account for the ignored MAC devices. We choose factor 1.0225 to allow for a safety margin: in the peaks of the graph in Fig. \ref{fig:randomized} the values are 0.025, and we would rather overestimate than underestimate the crowd density. 
